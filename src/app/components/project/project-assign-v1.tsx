...
const ProjectAssignScreenV1 = ({
  ...
  }, [currentStaffPage, saveAssign, projectid]);

  useEffect(() => {
    if (projectid) {
      fetchStaffData(1).catch(console.error);
    }
  }, [rSearchStaffName, rSearchDesignation, saveAssign, projectid]);
...
export default ProjectAssignScreenV1;
