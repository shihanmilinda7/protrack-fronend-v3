...
// import NewProjectTaskToDatabase from "@/app/components/project/project-task-addnew-db";
...
//           pathname + "/api/project/update-project?projectid=" + selProjectid
//         );
...
//       if (validation == 0) {
//         //api call
//         const response = await fetch(pathname + "/api/project/update-project", {
//           method: "POST",
