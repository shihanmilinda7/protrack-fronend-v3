...
import { TimelogSummaryPdf } from "../components/timelog-report/month-summary-pdf";
      ...
      <div>
        ...
        <div className="flex items-center justify-center p-1 pl-4">
          <div className=" mr-auto">
            ...
            {/* <TimelogSummaryPdf rowObjectIn={modifiedDateObjects} /> */}
          </div>
          ...
          <div className="ml-2 w-3/4 pl-1 mr-3">
            ...
            <div className="h-7">
              <div className="max-h-[80vh] overflow-y-auto">
                <TimelogSummaryTable rowObjectIn={modifiedDateObjects} staffname={staffname}/>
              </div>
            </div>
          </div>
        </div>
